...
import productTrialsRouter from './routes/product-trials.js';
...
import productParentsRouter from './routes/product-parents.js';
...
app.use('/api/product-trials', productTrialsRouter);
...
app.use('/api/product-parents', productParentsRouter);
